...
for wait_margin in wait_margins:
    # Results folder
    FOLDER = f"hpc_jobs/wait_margin_tests/bounded/wait_margin_{str(wait_margin).replace('.', '_')}/"
    os.makedirs(FOLDER, exist_ok=True)

    check_parameters_wait_margin(dvrp_file, wait_margin, FOLDER, "wait_first", margin_strategy="bounded")
