...
# Results folder
FOLDER = f"hpc_jobs/closest_first_tests/fullness_alpha_{str(alpha).replace('.', '_')}_epsilon_{str(epsilon).replace('.', '_')}/"
os.makedirs(FOLDER, exist_ok=True)

check_parameters(dvrp_file, alpha, epsilon, results_folder=FOLDER, route_orientation_strategy="closest_first")
