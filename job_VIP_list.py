...
# Results folder
FOLDER = f"hpc_jobs/VIP_list_tests/drive_first/"
os.makedirs(FOLDER, exist_ok=True)

runXTestsOnFile(dvrp_file, results_folder=FOLDER, waiting_strategy="drive_first", initial_routes_strategy="VIP_list")
