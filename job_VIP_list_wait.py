...
# Results folder
FOLDER = f"hpc_jobs/VIP_list_tests/wait_first/"
os.makedirs(FOLDER, exist_ok=True)

runXTestsOnFile(dvrp_file, results_folder=FOLDER, waiting_strategy="wait_first", initial_routes_strategy="VIP_list")
