...
# Results folder
FOLDER = f"hpc_jobs/clockwise_tests/wait_margin_{str(wait_margin).replace('.', '_')}/"
os.makedirs(FOLDER, exist_ok=True)

runXTestsOnFile(dvrp_file, results_folder=FOLDER, waiting_strategy="wait_first", wait_margin=wait_margin, route_orientation_strategy="clockwise")
